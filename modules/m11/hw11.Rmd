...
# Student Info
    ...
    Name:  Nathan Lyell
    Net ID: xuw9ap
    File GitHub URL:https://github.com/nlyell7/DS5100-2023-08-O/blob/main/modules/m11/hw11.rmd
...
# CODE HERE
library(dplyr)
snail <- read.csv("https://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data", header = FALSE)
```
